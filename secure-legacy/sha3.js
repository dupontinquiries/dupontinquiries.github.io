...
!(function () {
    ...
    for (
        var A = function (e, r, n) {
            ...
            k = [
                { name: "keccak", padding: [1, 256, 65536, 16777216], bits: d, createMethod: _ },
                { name: "sha3", padding: [6, 1536, 393216, 100663296], bits: d, createMethod: _ },
                {
                    name: "shake",
    ...
    (t.prototype.update = function (t) {
        ...
        for (var i, o, a = this.blocks, s = this.byteCount, f = t.length, c = this.blockCount, p = 0, d = this.s; p < f; ) {
            ...
            if (e) for (i = this.start; p < f && i < s; ++p) a[i >> 2] |= t[p] << h[3 & i++];
            else
                for (i = this.start; p < f && i < s; ++p)
                    (o = t.charCodeAt(p)) < 128
                        ? (a[i >> 2] |= o << h[3 & i++])
                        : o < 2048
                        ? ((a[i >> 2] |= (192 | (o >> 6)) << h[3 & i++]), (a[i >> 2] |= (128 | (63 & o)) << h[3 & i++]))
                        : o < 55296 || o >= 57344
                        ? ((a[i >> 2] |= (224 | (o >> 12)) << h[3 & i++]), (a[i >> 2] |= (128 | ((o >> 6) & 63)) << h[3 & i++]), (a[i >> 2] |= (128 | (63 & o)) << h[3 & i++]))
                        : ((o = 65536 + (((1023 & o) << 10) | (1023 & t.charCodeAt(++p)))),
    ...
    var j = function (t) {
        ...
        for (n = 0; n < 48; n += 2)
            (i = t[0] ^ t[10] ^ t[20] ^ t[30] ^ t[40]),
                ...
                (r = (l = t[9] ^ t[19] ^ t[29] ^ t[39] ^ t[49]) ^ ((s << 1) | (a >>> 31))),
                (t[0] ^= e),
                (t[1] ^= r),
                (t[10] ^= e),
                (t[11] ^= r),
